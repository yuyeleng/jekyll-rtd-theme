(() => {
	...
	$(window).bind("hashchange", (function() {
		...
		a.length > 0 && n.length > 0 ? ($(".search-results .content").html(a.join("")),console.log(a.join("")), $(".search-results .summary").html(ui.i18n.search_results_found.replace("#", a.length))) : ($(".search-results .content").empty(), $(".search-results .summary").html(ui.i18n.search_results_not_found)), $(".search-results h2").html(ui.i18n.search_results)
	})).fail((function(t, e) {
		return r(e)
